...
bundle: build/jquery-3.4.0.min.js build/r105.three.min.js build/OrbitControls.js build/fourd.js build/FourDCtrl.js build/dynamic-graph.js
	...
	minify build/jquery-3.4.0.min.js build/r105.three.min.js build/OrbitControls.js build/fourd.js build/animation.js build/FourDCtrl.js build/dynamic-graph.js > dist/dynamic-graph.bundle.min.js