...
only_wasm: src/FourDType.cpp src/Settings.cpp src/Settings.h src/Vertex.cpp src/Vertex.h src/Edge.cpp src/Edge.h src/BarnesHutNode3.cpp src/BarnesHutNode3.h src/LayoutGraph.cpp src/LayoutGraph.h src/fourd.cpp
	../emsdk/emscripten/incoming/em++ -I ./src/gmtl -std=c++11 -s ASSERTIONS=1 -s ALLOW_MEMORY_GROWTH=1 -s SAFE_HEAP=1 -s LINKABLE=1 src/FourDType.cpp -o dist/pure/FourDType.o
	../emsdk/emscripten/incoming/em++ -I ./src/gmtl -std=c++11 -s ASSERTIONS=1 -s ALLOW_MEMORY_GROWTH=1 -s SAFE_HEAP=1 -s LINKABLE=1 src/Settings.cpp -o dist/pure/Settings.o
	../emsdk/emscripten/incoming/em++ -I ./src/gmtl -std=c++11 -s ASSERTIONS=1 -s ALLOW_MEMORY_GROWTH=1 -s SAFE_HEAP=1 -s LINKABLE=1 src/Vertex.cpp -o dist/pure/Vertex.o
	../emsdk/emscripten/incoming/em++ -I ./src/gmtl -std=c++11 -s ASSERTIONS=1 -s ALLOW_MEMORY_GROWTH=1 -s SAFE_HEAP=1 -s LINKABLE=1 src/Edge.cpp -o dist/pure/Edge.o
	../emsdk/emscripten/incoming/em++ -I ./src/gmtl -std=c++11 -s ASSERTIONS=1 -s ALLOW_MEMORY_GROWTH=1 -s SAFE_HEAP=1 -s LINKABLE=1 src/BarnesHutNode3.cpp -o dist/pure/BarnesHutNode3.o
	../emsdk/emscripten/incoming/em++ -I ./src/gmtl -std=c++11 -s ASSERTIONS=1 -s ALLOW_MEMORY_GROWTH=1 -s SAFE_HEAP=1 -s LINKABLE=1 src/LayoutGraph.cpp -o dist/pure/LayoutGraph.o
	../emsdk/emscripten/incoming/em++ -I ./src/gmtl -std=c++11 -s ASSERTIONS=1 -s ALLOW_MEMORY_GROWTH=1 -s SAFE_HEAP=1 dist/pure/FourDType.o dist/pure/Settings.o dist/pure/Vertex.o dist/pure/Edge.o dist/pure/BarnesHutNode3.o dist/pure/LayoutGraph.o src/fourd.cpp --bind -o dist/pure/fourd.wasm
